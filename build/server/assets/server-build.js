...
import { useState, useEffect, Component, useRef, useCallback, useContext, createContext, useMemo } from "react";
import { f as fetchWithHeaders } from "./index-TlSKNwFd.js";
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(Field$1, { label: "Role", children: isHospitalAccount ? /* @__PURE__ */ jsxs(
                ...
                /* @__PURE__ */ jsx("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }, children: [
                  { value: "donor", label: "Donor", Icon: Droplets },
                  { value: "requester", label: "Patient / Family", Icon: User }
                ...
                roleChanged && /* @__PURE__ */ jsxs(
                  "label",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("span", { style: { fontSize: "12px", color: "#9A3412", lineHeight: "1.5" }, children: "I understand this changes my active app mode and the screens I use after saving." })
                    ]
                  }
                )
              ] }) }),
              form.role === "donor" && !form.bloodGroup && /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(AlertTriangle, { size: 16, color: "#922B21", style: { flexShrink: 0, marginTop: "1px" } }),
                    /* @__PURE__ */ jsx("span", { style: { fontSize: "12px", color: "#922B21", fontWeight: "600", lineHeight: "1.5" }, children: "Blood type is required before using donor mode." })
                  ]
                }
              ),
              /* @__PURE__ */ jsxs(
                "label",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx("span", { style: { fontSize: "13px", fontWeight: "600", color: "#1A1A1A" }, children: "Availability" }),
                    /* @__PURE__ */ jsx(
                      "input",
                      {
                        type: "checkbox",
