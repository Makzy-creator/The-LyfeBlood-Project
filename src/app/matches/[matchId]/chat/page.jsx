      ...
      <div style={{ padding: "12px", display: "flex", flexDirection: "column", gap: "12px", flex: 1 }}>
        ...
        >
          {loading ? (
            ...
            <p style={{ margin: "auto", fontSize: "14px", color: "#922B21", fontWeight: "700", textAlign: "center" }}>
              {error}
            </p>
          ) : messages.length === 0 ? (
            <p style={{ margin: "auto", fontSize: "14px", color: "#6B6B6B", fontWeight: "600", textAlign: "center" }}>
              No messages yet.
            </p>
          ) : (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "8px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
            <SecondaryButton onClick={() => navigate(-1)} icon={ChevronLeft}>
              Back
            </SecondaryButton>
            <PrimaryButton onClick={() => navigate(`/matches/${matchId}/tracking`)} icon={Navigation}>
              Tracking
            </PrimaryButton>
          </div>
        </div>
