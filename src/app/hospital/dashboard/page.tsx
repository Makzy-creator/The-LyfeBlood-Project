      ...
      >
        ...
        >
          {isSOS && (
            ...
            >
              <Radio size={15} color="#922B21" style={{ flexShrink: 0, marginTop: '1px' }} />
              <p
                style={{
                  fontSize: '12px',
                  color: '#922B21',
              ...
              >
                <strong>SOS mode:</strong> This request will be broadcast immediately to ALL
                available matching donors in Imo State with the highest priority alert.
              </p>
            </div>
          )}
...
export default function HospitalDashboardPage() {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- loadAcceptedMatches manages its own loading state
    loadAcceptedMatches()
  ...
  return (
    <>
      ...
      >
        <TopAppBar title="Blood Bank Command" onBellPress={markAllNotificationsRead} />
        ...
        <section style={{ padding: '20px 12px 0' }}>
          ...
          {activeRequests.length === 0 ? (
            ...
            >
              ...
              >
                Tap "New Request" or "TRIGGER SOS BROADCAST" above to create your first blood
                procurement request.
              </p>
            </div>
          ) : (
        ...
        {/* ── FULFILLED REQUESTS ─────────────────────────────────────── */}
        {bloodRequests.filter((r) => r.status === REQUEST_STATUS.FULFILLED).length > 0 && (
      ...
      <BottomNavBar
        onNavigate={(key) => {
          ...
          if (key === 'home') router.push('/hospital/dashboard')
