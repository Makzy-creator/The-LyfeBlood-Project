    ...
    <>
      <div style={{ display: "flex", flexDirection: "column", flex: 1, paddingBottom: "80px" }}>
        ...
        <main style={{ padding: "16px 12px 20px", display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          {loading && (
            <p style={{ margin: 0, fontSize: "13px", color: "#6B6B6B" }}>Loading donation history...</p>
          )}
          {error && (
            <p style={{ margin: 0, color: "#922B21", fontSize: "13px", fontWeight: "700" }}>{error}</p>
          )}
          ...
          {matches.map((match) => (
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", gap: "10px", alignItems: "flex-start" }}>
                <div>
                  <p style={{ margin: "0 0 3px", fontSize: "14px", fontWeight: "800", color: "#1A1A1A" }}>
              ...
              <span style={{ display: "flex", alignItems: "center", gap: "5px", fontSize: "12px", color: "#4A4A4A" }}>
