  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span style={{ fontSize: '10px', color: '#FFFFFF', fontWeight: '600' }}>Live · Owerri</span>
      </div>
    </div>
  )
}
...
export default function MatchPage() {
  ...
  }, [isAuthenticated, refreshCurrentUser, router])
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      if (typeof window !== 'undefined') {
        router.push(`/matches/${matchId}/tracking`)
      }
    } catch (error) {
  ...
  const handleDecline = async () => {
    ...
    try {
      ...
      if (typeof window !== 'undefined') router.push('/donor/home')
    } catch (error) {
    ...
    <>
      ...
      >
        ...
        <div style={{ flex: 1, padding: '16px', overflowY: 'auto' }}>
          ...
          {/* Map widget */}
          <MapWidget distanceKm={match.distanceKm} hospitalName={match.hospitalName} />
          ...
          >
            ...
            {[
              ...
              >
                <Icon size={14} color="#C0392B" style={{ marginTop: '2px', flexShrink: 0 }} />
                <div>
                  <p
                    style={{
                      fontSize: '11px',
          ...
          >
            {match.status === 'Accepted' && (
              <>
                <PrimaryButton
                  onClick={() => {
                    if (typeof window !== 'undefined') router.push(`/matches/${matchId}/tracking`)
                  }}
                  icon={Navigation}
                >
                  Open Tracking
                ...
                <SecondaryButton
                  onClick={() => {
                    if (typeof window !== 'undefined') router.push(`/matches/${matchId}/chat`)
                  }}
                  icon={MessageCircle}
                >
                  Open Chat
            ...
            {match.status === 'Alerted' && isCoolingDown && (
              ...
              >
                Donation actions are disabled for {cooldownDays} more day
                {cooldownDays === 1 ? '' : 's'}.
              </p>
            )}
            {respondError && (
            ...
            {match.status === 'Alerted' && (
              <>
                ...
                >
                  Declining will pass this match to another available donor. Your availability
                  status will remain on.
                </p>
              </>
            )}
          </div>
