    ...
    <>
            ...
            <Field label="Role">
              {isHospitalAccount ? (
                ...
                >
                  ...
                  >
                    Hospital accounts cannot switch into donor or patient mode
                    from profile.
                  </p>
                </div>
              ) : (
                  ...
                  {roleChanged && (
                    ...
                    >
                      <input
                        ...
                        onChange={(e) =>
                          setRoleSwitchConfirmed(e.target.checked)
                        }
                        style={{
                          width: "18px",
                          height: "18px",
                      ...
                      >
                        I understand this changes my active app mode and the
                        screens I use after saving.
                      </span>
                    </label>
                  )}
                </>
      ...
      <BottomNavBar
        onNavigate={(key) => {
          if (key === "home")
            navigate(
              ROLE_HOME_ROUTE[normalizeProfileRole(currentUser.role)] ??
                "/dashboard",
            );
