    ...
    <>
      ...
      >
        ...
        <section
          style={{
            background:
              "linear-gradient(160deg, #922B21 0%, #C0392B 55%, #E74C3C 100%)",
        ...
        >
          ...
          >
            Connecting blood donors directly with patients and hospitals across
            Owerri and Imo State — in minutes, not hours.
          </p>
        ...
        <section style={{ padding: "20px 16px" }}>
          ...
          {bloodRequests.length > 2 && (
            ...
            >
              {showAll
                ? "Show less"
                : `View all ${bloodRequests.length} requests`}
        ...
        >
          ...
          <div>
            ...
            >
              LyfeBlood facilitates donor–hospital connections only. All
              clinical screening, compatibility testing, and transfusion
              decisions are performed exclusively by licensed medical
              professionals.
            </p>
          </div>
        </section>
