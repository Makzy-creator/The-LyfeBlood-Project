    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
      ...
      <Field label="Facility Type" required>
        <select
          ...
          onChange={(e) =>
            setForm((f) => ({ ...f, facilityType: e.target.value }))
          }
        >
...
function Step3Donor({ form, setForm }) {
  ...
  const handleFile = (file) => {
    ...
    reader.onload = (e) =>
      setForm((f) => ({ ...f, kycFile: file, kycPreview: e.target.result }));
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      >
        ...
        >
          Your ID is encrypted and used solely to verify donor identity. It is
    ...
    <>
      ...
      >
        ...
        <div style={{ flex: 1, padding: "24px 16px 100px", overflowY: "auto" }}>
          ...
          {step === 2 && role === "donor" && (
            <Step2Donor form={form} setForm={setForm} />
          )}
          {step === 2 && role === "requester" && (
            <Step2Requester form={form} setForm={setForm} />
          )}
          {step === 2 && role === "hospital" && (
            <Step2Hospital form={form} setForm={setForm} />
          )}
          {step === 3 && role === "donor" && (
            <Step3Donor form={form} setForm={setForm} />
          )}
