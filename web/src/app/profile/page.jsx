        ...
        <div style={{ padding: "16px 12px 20px" }}>
          ...
          >
                  ...
                  {roleChanged && (
                    ...
                    >
                      ...
                      <span style={{ fontSize: "12px", color: "#9A3412", lineHeight: "1.5" }}>
                        I understand this changes my active app mode and the screens I use after saving.
                      </span>
                    </label>
                  )}
                </>
            ...
            {form.role === "donor" && !form.bloodGroup && (
              ...
              >
                <AlertTriangle size={16} color="#922B21" style={{ flexShrink: 0, marginTop: "1px" }} />
                <span style={{ fontSize: "12px", color: "#922B21", fontWeight: "600", lineHeight: "1.5" }}>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              <SecondaryButton onClick={() => navigate(-1)} style={{ flex: 1 }}>
                Cancel
              </SecondaryButton>
              <PrimaryButton
                onClick={handleSave}
