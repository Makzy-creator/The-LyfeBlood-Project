...
// src/app/requests/[requestId]/page.jsx
...
function PrimaryButton({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        Icon && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Icon, { size: 18, strokeWidth: 2.2 }),
        children
      ]
    }
  );
...
function DetailRow({ label, value }) {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "3px" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontSize: "11px", fontWeight: "700", color: "#6B6B6B", textTransform: "uppercase" }, children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontSize: "14px", fontWeight: "600", color: "#1A1A1A", lineHeight: "1.4" }, children: value || "Not provided" })
  ] });
}
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "8px" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Icon, { size: 18, color: "#C0392B" }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h2", { style: { margin: 0, fontSize: "15px", fontWeight: "800", color: "#1A1A1A" }, children: title })
        ] }),
        children
      ]
    }
...
function RequestDetailsPage() {
  ...
  const [consented, setConsented] = (0, import_react5.useState)(false);
  const [flagReason, setFlagReason] = (0, import_react5.useState)("");
  const [flagged, setFlagged] = (0, import_react5.useState)(false);
  (0, import_react5.useEffect)(() => {
    if (!isAuthenticated) navigate("/login");
  }, [isAuthenticated, navigate]);
  if (!currentUser) return null;
  const request = bloodRequests.find((item) => String(item.id) === String(requestId));
  const role = currentUser.role;
  const homeRoute = ROLE_HOME_ROUTE[role] ?? "/dashboard";
  const isHospital = role === "hospital" || role === "hospital_officer";
  if (!request) {
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", flexDirection: "column", flex: 1, paddingBottom: "80px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(TopAppBar, { title: "Request Details", onBellPress: markAllNotificationsRead }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { padding: "24px 12px" }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(Section, { title: "Request unavailable", icon: TriangleAlert, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { style: { margin: 0, fontSize: "14px", color: "#4A4A4A", lineHeight: "1.5" }, children: "This request is not in the current live request feed." }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SecondaryButton, { onClick: () => navigate(homeRoute), icon: ChevronLeft, children: "Back to Dashboard" })
        ] }) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BottomNavBar, { onNavigate: (key) => {
        if (key === "home") navigate(homeRoute);
        if (key === "profile") navigate("/profile");
      } })
    ] });
  }
  const canMarkMatched = isHospital && request.status === REQUEST_STATUS.PENDING;
  const handleFlag = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", flexDirection: "column", flex: 1, paddingBottom: "80px" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(TopAppBar, { title: "Request Details", onBellPress: markAllNotificationsRead }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { padding: "16px 12px 20px", display: "flex", flexDirection: "column", gap: "12px" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
          "button",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(ChevronLeft, { size: 20, color: "#1A1A1A" })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(Section, { title: "Request Summary", icon: ClipboardCheck, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", gap: "12px", alignItems: "flex-start" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: "10px" }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BloodGroupTag, { group: request.bloodGroup, size: "lg" }),
              /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { style: { margin: "0 0 3px", fontSize: "15px", fontWeight: "800", color: "#1A1A1A" }, children: request.hospitalName }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { style: { margin: 0, fontSize: "12px", color: "#6B6B6B" }, children: request.ward })
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(RequestStatusBadge, { status: request.status, size: "sm" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(DetailRow, { label: "Units", value: `${request.unitsFulfilled}/${request.unitsNeeded}` }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(DetailRow, { label: "Priority", value: request.tier === "sos" ? "SOS" : "Standard" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(DetailRow, { label: "Case Ref", value: request.patientCode }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(DetailRow, { label: "Location", value: request.location })
          ] }),
          request.urgencyNote && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { style: { margin: 0, fontSize: "13px", color: "#922B21", lineHeight: "1.5", fontWeight: "600" }, children: request.urgencyNote })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(Section, { title: "Verification & Status", icon: ShieldCheck, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(DetailRow, { label: "Current status", value: request.status.replaceAll("_", " ") }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { style: { margin: 0, fontSize: "12px", color: "#4A4A4A", lineHeight: "1.5" }, children: "Donors should only proceed after confirming this request with hospital staff. Hospital staff should update the status only after verification at the facility." }),
          canMarkMatched && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            PrimaryButton,
            {
              onClick: () => updateRequestStatus(request.id, REQUEST_STATUS.DONOR_MATCHED),
              icon: CircleCheck,
              children: "Mark Donor Matched"
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(Section, { title: "Emergency Contact", icon: Phone, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(DetailRow, { label: "Facility", value: request.hospitalName }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(DetailRow, { label: "Where to go", value: request.location || request.ward }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Phone, { size: 16 }),
                "Call Emergency Line"
              ]
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(Section, { title: "Privacy & Consent", icon: ShieldCheck, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("label", { style: { display: "flex", alignItems: "flex-start", gap: "10px", cursor: "pointer" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
              "input",
              {
                type: "checkbox",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontSize: "12px", color: "#4A4A4A", lineHeight: "1.5" }, children: "I understand this request may contain sensitive medical context and should only be used for donation coordination with authorized hospital staff." })
          ] }),
          consented && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { style: { margin: 0, fontSize: "12px", color: "#1E8449", fontWeight: "700" }, children: "Consent acknowledged for this session." })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(Section, { title: "Report / Flag Request", icon: Flag, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
            "select",
            {
              value: flagReason,
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "", children: "Select a reason" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "incorrect_details", children: "Incorrect request details" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "duplicate", children: "Duplicate request" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "unsafe_contact", children: "Unsafe or suspicious contact" }),
                /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("option", { value: "privacy", children: "Privacy concern" })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SecondaryButton, { onClick: handleFlag, disabled: !flagReason, icon: Flag, children: "Flag Request" }),
          flagged && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { style: { margin: 0, fontSize: "12px", color: "#922B21", fontWeight: "700" }, children: "Flag recorded locally for hospital-testing review." })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(BottomNavBar, { onNavigate: (key) => {
